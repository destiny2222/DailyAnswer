      ...
      <View className="bg-slate-800 rounded-t-2xl p-6">
        ...
        <View className="mb-4">
          <Text className="text-base text-gray-300 mb-1">
            - For support, feedback and business inquiries at: <Text className="text-blue-400">womeninleadership206@gmail.com</Text>
          </Text>
        </View>
...
const TermsOfServiceModal = ({ visible, onClose }) => (
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <View className="flex-1 justify-end bg-black/50">
        ...
        <View className="bg-slate-800 rounded-t-2xl p-6" style={{ maxHeight: '80%' }}>
          <View className="items-center mb-6">
            <View className="w-12 h-1.5 bg-gray-500 rounded-full" />
          </View>
